/*
Reexport von allen API Modulen sowie BO's benoetigt da sonst import nicht funktioniert
*/
...
export {default as LernvorliebenBO} from './LernvorliebenBO';
export {default as KonversationBO} from './KonversationBO';
